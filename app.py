#!/data/virtualenvs/todo-api/bin/python
...
tasks = [
    {
        'id': 1,
        'title': u'Learn programming',
        'description': u'Python, Django, Algorithms, Patterns',
        'done': False

    },
    {
        'id': 2,
        'title': u'Reading books',
        'description': u'Philosophy, psihologie',
        'done': False
